...
use Tokenmapper\Resource\MariaDB\Aspect\TestData\ApproachScaffold\items\field as SelfField;
use \Approach\Resource\MariaDB\Aspect\quality as quality_meta;
use Tokenmapper\Resource\MariaDB\Aspect\TestData\ApproachScaffold\items\quality as SelfQuality;
...
static array $profile = [
	...
	Aspect::field => [
		...
		SelfField::price => [
			field_meta::label => SelfField::_approach_field_profile_[ field_meta::label ][ SelfField::price],
			field_meta::type => SelfField::_approach_field_profile_[ field_meta::type ][ SelfField::price],
			field_meta::default => SelfField::_approach_field_profile_[ field_meta::default ][ SelfField::price],
			field_meta::source_type => SelfField::_approach_field_profile_[ field_meta::source_type ][ SelfField::price],
			field_meta::source_default => SelfField::_approach_field_profile_[ field_meta::source_default ][ SelfField::price],
			field_meta::nullable => SelfField::_approach_field_profile_[ field_meta::nullable ][ SelfField::price],
			field_meta::description => SelfField::_approach_field_profile_[ field_meta::description ][ SelfField::price],
			field_meta::constraint => SelfField::_approach_field_profile_[ field_meta::constraint ][ SelfField::price],
			field_meta::accessor => SelfField::_approach_field_profile_[ field_meta::accessor ][ SelfField::price],
			field_meta::reference_to => SelfField::_approach_field_profile_[ field_meta::reference_to ][ SelfField::price],
			field_meta::primary_accessor => SelfField::_approach_field_profile_[ field_meta::primary_accessor ][ SelfField::price],
		],
	],
	Aspect::quality => [
